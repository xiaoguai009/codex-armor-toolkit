...
**Windows · CMD 自动版 · v1.3.2**

一键配置 · 保留原指令 · 本地备份 · 精确口令 · 内置恢复

[下载 v1.3.2](downloads/xiaoguai-oneclick-v1.3.2.zip) · [快速开始](#quick-start) · [命令行参数](#options) · [交流与支持](#contact)
...
- **重复安装**：内容未变时不重复写入；从 v1.3.0 / v1.3.1 升级时更新旧口令块，保留其他正文及首次备份。
...
| 旧版升级 | v1.3.0 / v1.3.1 可直接再次安装，更新为包含频道与 QQ 群的两行确认口令 |
...
| 自动化测试 | 隔离配置目录下 56 项测试通过，0 项跳过，覆盖源码、EXE 与 CMD 流程 |
...
下载 [小怪破甲 v1.3.2 安装包](downloads/xiaoguai-oneclick-v1.3.2.zip)，将压缩包完整解压到一个文件夹。

历史下载：[v1.3.1 安装包](downloads/xiaoguai-oneclick-v1.3.1.zip)。
...
├── downloads/
│   ├── xiaoguai-oneclick-v1.3.2.zip   # 当前版本安装包
