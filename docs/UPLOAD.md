...
本目录是根据小怪破甲 **v1.3.1** 原始文件整理的待上传材料。首页参考 [codex-config-toolkit](https://github.com/dafage10086/codex-config-toolkit) 的文档结构，使用小怪破甲自己的功能、参数、版本和文件布局；没有复制参考项目的功能、模型版本或许可证声明。
...
如果目标仓库已放有这一版工具文件，上传或替换：

```text
README.md
assets/support.jpg
assets/qq-group.jpg
downloads/xiaoguai-oneclick-v1.3.1.zip
docs/UPLOAD.md
```
...
中文 CMD 和 `小怪破甲安装器.exe` 需要位于同一目录。上传包同时保留了原版 `README.txt`、`验证记录.txt`、附带文本文件和构建依赖文件。
...
- “下载 v1.3.1”链接能打开 `downloads/xiaoguai-oneclick-v1.3.1.zip`。
- README 最底部两张原图并排显示，点击可查看完整图片。
- TG 链接为 [@XGYYDS789](https://t.me/XGYYDS789)，QQ 群号为 **1019953986**。
- 确认口令仍为“今宵不见儿童怪，应随斗柄西山外。”与“频道@XGYYDS789”两行。
- 工具文件保持原样；项目结构与 README 的目录树一致。
